...
public class CalculationPeriodTest {
  ...
  @Test
  public void coverWithAmounts() throws IOException {
    ProjectionBuilder builder = repo.projection();
    
    CoverBuilder coverBuilder = builder.cover()
      .id("1").origin(getClass())
      .startDate(LocalDate.of(2021, 4, 30))
      .endDate(LocalDate.of(2025, 8, 30))
      .type("insurance-cover");

    coverBuilder.addPeriod()
      .lengthInMonths(1)
      .startDate(LocalDate.of(2021, 4, 30).plusDays(1))
      .dueDate(LocalDate.of(2021, 5, 30))
      .endDate(LocalDate.of(2021, 5, 30))
      .build();
    
    coverBuilder.addPeriod()
      .lengthInMonths(1)
      .startDate(LocalDate.of(2021, 5, 30).plusDays(1))
      .dueDate(LocalDate.of(2021, 6, 30))
    ...
    Projection calculation = builder.lastDueDate(LocalDate.of(2021, 5, 30)).build();
    var actual = prettyPrint(calculation);
    var expected = TestUtils.toString(getClass(), "cover-with-amounts.txt");
